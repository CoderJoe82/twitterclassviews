...
SECRET_KEY = 'nq5$v7sl0cj7x(l)ni6wf)*+0@v5b#%_8owttxb##o#&2iea7_'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR), 'templates/tweet',
                 'templates/authentication', 'templates/notification',
                 'templates/twitteruser'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
